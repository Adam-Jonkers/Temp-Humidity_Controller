...
(library Library_1
	...
	(patternDef "1760520000" (originalName "1760520000")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 5.080, 0.200) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 4.2) (pt 12.7 4.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 12.7 4.2) (pt 12.7 -3.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 12.7 -3.8) (pt -2.54 -3.8) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 -3.8) (pt -2.54 4.2) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "1760520000" (originalName "1760520000") (compHeader (numPins 3) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://catalog.weidmueller.com/createDatasheetForMobile.do?ordernumber=1760520000&scope1=1&scope2=1&localeId=en")
		(attr "<Component Height>" "10")
		(attr "<STEP Filename>" "1760520000.stp")

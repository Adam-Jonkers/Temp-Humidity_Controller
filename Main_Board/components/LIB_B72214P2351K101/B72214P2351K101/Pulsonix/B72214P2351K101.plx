...
(library Library_1
	...
	(patternDef "B72214P2351K101" (originalName "B72214P2351K101")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 3.750, -1.950) (textStyleRef "Normal") (isVisible True))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.15 1.4) (pt 8.65 1.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.65 1.4) (pt 8.65 1.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 8.65, -1.95) (radius 3.35) (startAngle 90.0) (sweepAngle -180.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.65 -5.3) (pt -1.15 -5.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.15 -5.3) (pt -1.15 -5.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt -1.15, -1.95) (radius 3.35) (startAngle 270) (sweepAngle -180.0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "B72214P2351K101" (originalName "B72214P2351K101") (compHeader (numPins 2) (numParts 1) (refDesPrefix RV)
		...
		(attr "<Hyperlink>" "https://product.tdk.com/system/files/dam/doc/product/protection/voltage/lead-disk-varistor/data_sheet/70/db/var/siov_leaded_advanced_mp_14mm.pdf")
		(attr "<Component Height>" "20.5")
		(attr "<STEP Filename>" "B72214P2351K101.stp")
		(attr "<STEP Offsets>" "X=3.75;Y=-1.95;Z=34.75")

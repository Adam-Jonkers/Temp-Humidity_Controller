...
(library Library_1
	...
	(patternDef "696105003002" (originalName "696105003002")
		...
		(layerContents (layerNumRef 28)
			(line (pt -4.7 4.7) (pt 19.7 4.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 19.7 4.7) (pt 19.7 -4.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 19.7 -4.7) (pt -4.7 -4.7) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4.7 -4.7) (pt -4.7 4.7) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "696105003002" (originalName "696105003002") (compHeader (numPins 2) (numParts 1) (refDesPrefix U)
		...
		(attr "<Hyperlink>" "https://www.we-online.com/catalog/datasheet/696105003002.pdf")
		(attr "<Component Height>" "11.6")
		(attr "<STEP Filename>" "696105003002.stp")

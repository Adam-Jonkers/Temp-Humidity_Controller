...
(library Library_1
	...
	(patternDef "BS270" (originalName "BS270")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.270, 0.167) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.985 1.905) (pt 3.525 1.905) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.525 1.905) (pt 3.525 -1.635) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.525 -1.635) (pt -0.985 -1.635) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.985 -1.635) (pt -0.985 1.905) (width 0.2))
		)
	...
	(compDef "BS270" (originalName "BS270") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		...
		(attr "Datasheet Link" "https://www.onsemi.com/pub/Collateral/BS270-D.PDF")
	)
